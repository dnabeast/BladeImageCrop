...
class SourcesTest extends TestCase
{
	...
	function if_blade_command_sources_requested_return_a_html_string(){
		...
		$expected = <<<EOT
		<source media="test" type="image/webp" srcset="/storage/blade_image_crop_holding/uploadsbannerspagecaterjpg_jpg/bic_800x600_50_50.webp 1x,/storage/blade_image_crop_holding/uploadsbannerspagecaterjpg_jpg/bic_1600x1200_50_50.webp 2x" sizes="sizeTest">
		<source media="test" type="image/jpeg" srcset="/storage/blade_image_crop_holding/uploadsbannerspagecaterjpg_jpg/bic_800x600_50_50.jpg 1x,/storage/blade_image_crop_holding/uploadsbannerspagecaterjpg_jpg/bic_1600x1200_50_50.jpg 2x" sizes="sizeTest">
		EOT;
	...
	function if_blade_command_sources_requested_with_many_properties_return_a_html_string(){
		...
		<source media="test" type="image/jpeg" srcset="/storage/blade_image_crop_holding/uploadsbannerspagecaterjpg_jpg/bic_800x600_50_50.jpg 800w,/storage/blade_image_crop_holding/uploadsbannerspagecaterjpg_jpg/bic_1024x768_50_50.jpg 1024w" sizes="sizeTest">
		EOT;
